...
const translations = {
  zh: {
    pageTitle: '从一期落客点到大宴会厅 C｜2026 云栖大会',
    pageDescription: '从杭州国际博览中心一期网约车落客点，步行引导至 3F 大宴会厅 C。',
    brandAria: '返回页面顶部',
    pageNav: '页面导航',
    languageSwitch: '语言切换',
    navRoute: '路线',
    ...
    navOfficial: '官方指南',
    onsite: '现场引导',
    heroEyebrow: '杭州国际博览中心 · 一期',
    heroTitle: '从一期网约车落客点<br><span>到大宴会厅 C</span>',
    heroLead: '下车后，先找到一期签到处；入场后上到 3F，沿着现场导视就能到达大宴会厅 C。',
    startGuide: '开始引导',
    copyDropoff: '复制落客点名称',
    ...
    step2Kicker: 'LOOK FOR / 找入口',
    step2Title: '沿导视前往一期签到处',
    step2Body: '下车后跟随“杭州国际博览中心一期 / 一期签到处”标识，前往一期入口。官方指南提示，一期入口在二层。',
    photoCheckin: '一期签到处实景',
    mapCheckinTitle: '一期签到处',
    mapCheckinNext: '前往 3F',
    mapCheckinAria: '一期签到处示意平面图，签到点已标记',
    checkCheckin: '我已找到一期签到处',
    step3Kicker: 'GO UP / 上楼',
    step3Title: '入场后前往 3F',
    step3Body: '完成签到和入场核验后，跟随场馆内的楼层指引，乘扶梯或电梯前往 3F。优先寻找“3F / 大宴会厅”方向牌。',
    photoFloor: '3F 导视实景',
    mapFloorTitle: '3F 导视节点',
    mapFloorNext: '大宴会厅方向',
    mapFloorAria: '3F 导视节点示意平面图，前往大宴会厅方向已标记',
    checkFloor: '我已到达 3F',
    step4Kicker: 'ARRIVAL / 到达',
    step4Title: '大宴会厅 C',
    step4Body: '在 3F 找到“大宴会厅 C”门头或现场指引牌。官网日程中的标准地点写法是：<strong>国博一期-3F-大宴会厅C</strong>。',
    photoHall: '宴会厅 C 门头实景',
    mapHallTitle: '大宴会厅 C',
    mapHallNext: '到达',
    mapHallAria: '大宴会厅 C 示意平面图，到达点已标记',
  ...
  en: {
    pageTitle: 'From Phase 1 Drop-off to Grand Banquet Hall C | Yunqi 2026',
    pageDescription: 'A mobile-first wayfinding guide from the Phase 1 ride-hailing drop-off point to Grand Banquet Hall C on 3F.',
    ...
    heroEyebrow: 'HANGZHOU INTERNATIONAL EXPO CENTRE · PHASE 1',
    heroTitle: 'From the Phase 1<br><span>ride-hailing drop-off to Hall C</span>',
    heroLead: 'After you get out, find the Phase 1 check-in entrance. Once inside, go to 3F and follow the signs to Grand Banquet Hall C.',
    startGuide: 'Start guide',
    copyDropoff: 'Copy drop-off name',
    sourceNote: 'Route details checked against the official Yunqi Conference attendee guide',
    ...
    step1Body: 'Make sure the driver stops at “Yunqi Conference ride-hailing drop-off · Phase 1”. Do not follow the Phase 2 or coach drop-off signs.',
    ...
    step2Kicker: 'LOOK FOR / ENTRANCE',
    step2Title: 'Follow signs to Phase 1 check-in',
    step2Body: 'Follow the “Hangzhou International Expo Centre Phase 1 / Phase 1 check-in” signs. The official guide places the Phase 1 entrance on Level 2.',
    photoCheckin: 'Phase 1 check-in photo',
    mapCheckinTitle: 'Phase 1 check-in',
    mapCheckinNext: 'Go to 3F',
    mapCheckinAria: 'Schematic floor map of Phase 1 check-in',
    checkCheckin: 'I found Phase 1 check-in',
    step3Kicker: 'GO UP / LEVEL 3',
    step3Title: 'Go to 3F after entry',
    step3Body: 'After check-in and entry verification, follow the in-venue floor signs to 3F by escalator or lift. Look for the “3F / Grand Banquet Hall” direction sign.',
    photoFloor: '3F wayfinding photo',
    mapFloorTitle: '3F wayfinding node',
    mapFloorNext: 'Hall direction',
    mapFloorAria: 'Schematic floor map of the 3F wayfinding node',
    checkFloor: 'I am on 3F',
    step4Kicker: 'ARRIVAL / YOU ARE HERE',
    step4Title: 'Grand Banquet Hall C',
    step4Body: 'On 3F, look for the Grand Banquet Hall C entrance or the on-site direction board. The official agenda location is: <strong>Phase 1-3F-Grand Banquet Hall C</strong>.',
    photoHall: 'Hall C entrance photo',
    mapHallTitle: 'Grand Banquet Hall C',
    mapHallNext: 'ARRIVAL',
    mapHallAria: 'Schematic floor map of Grand Banquet Hall C',
    ...
    mapAlt: 'Official Yunqi Conference traffic and check-in overview for Phase 1 and Phase 2',
    ...
    officialSite: 'Yunqi Conference website ↗',
